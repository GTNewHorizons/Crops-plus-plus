...
public class GTVanillaMachineRecipeLoader implements Runnable {
    ...
    public void run() {
        ...
        //coral buff
        GT_Values.RA.addAutoclaveRecipe(GT_ModHandler.getModItem("BiomesOPlenty", "coral1", 64L, 15), Materials.UUMatter.getFluid(2L), Materials.Sunnarium.getDust(4), 10000, 15000, 7680, true);
