...
public class CCropUtility {
            ...
            if(item == Ic2Items.hazmatBoots.getItem() ){
                ...
                if(!elTarget.worldObj.isRemote){
                    ...
                    if(boots.stackSize==0){
                        //Make SOme sounds
                        ent.worldObj.playSoundAtEntity(ent,"random.break", 0.8F, 0.8F + elTarget.getRNG().nextFloat() * 0.4F);
    ...
    public static void makeParticles(EntityLivingBase ent , ItemStack itemStack) {
        ...
        s.func_147487_a("iconcrack_" + Item.getIdFromItem(itemStack.getItem()), vec31.xCoord, vec31.yCoord, vec31.zCoord, 3 ,0, 0, 0 ,0.1);
    }
