...
public enum Bonsais {
    OAK(
            "Oak",
            1,
            new String[] {"Tree", "Bonsai", "Leavy", "Food"},
            "Notch",
            new ItemStack(Blocks.sapling),
            new ItemStack[] {
                new ItemStack(Blocks.log, Bonsais.LOGSPERHARVEST),
                new ItemStack(Blocks.sapling),
    ...
    SPRUCE(
            "Spruce",
            1,
            new String[] {"Tree", "Bonsai", "Leavy"},
            "Notch",
            new ItemStack(Blocks.sapling, 1, 1),
            new ItemStack[] {new ItemStack(Blocks.log, Bonsais.LOGSPERHARVEST, 1), new ItemStack(Blocks.sapling, 1, 1)},
            new int[] {80, 30},
            null,
            null),
    BIRCH(
            ...
            new ItemStack[] {new ItemStack(Blocks.log, Bonsais.LOGSPERHARVEST, 2), new ItemStack(Blocks.sapling, 1, 2)},
            new int[] {80, 30},
            null,
            null),
    JUNGLE(
            ...
            new ItemStack[] {new ItemStack(Blocks.log, Bonsais.LOGSPERHARVEST, 3), new ItemStack(Blocks.sapling, 1, 3)},
            new int[] {80, 30},
            null,
            null),
    ACACIA(
    ...
    DARKOAK(
            "Dark Oak",
            1,
            new String[] {"Tree", "Bonsai", "Leavy", "Dark"},
            "Notch",
            new ItemStack(Blocks.sapling, 1, 5),
            new ItemStack[] {new ItemStack(Blocks.log2, Bonsais.LOGSPERHARVEST, 1), new ItemStack(Blocks.sapling, 1, 5)
            },
            new int[] {80, 30},
            null,
            null),
    ...
    Bonsais(
        ...
        bonsais = new InternalVanillaBonsais(
                name, tier, attributes, discoveredBy, gain, chances, pathToSprites, additionalDescriton);
        this.seed = seed;
