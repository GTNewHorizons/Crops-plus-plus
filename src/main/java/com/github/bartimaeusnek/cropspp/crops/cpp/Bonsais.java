...
public enum Bonsais {
    ...
    OAK("Oak", 1, new String[] { "Tree", "Bonsai", "Leavy", "Food" }, "Notch", new ItemStack(Blocks.sapling),
    ...
    SPRUCE("Spruce", 1, new String[] { "Tree", "Bonsai", "Leavy" }, "Notch", new ItemStack(Blocks.sapling, 1, 1),
            new ItemStack[] { new ItemStack(Blocks.log, Bonsais.LOGSPERHARVEST, 1),
                    new ItemStack(Blocks.sapling, 1, 1) },
            new int[] { 80, 30 }, null, null),
    BIRCH("Birch", 1, new String[] { "Tree", "Bonsai", "Leavy" }, "Notch", new ItemStack(Blocks.sapling, 1, 2),
            new ItemStack[] { new ItemStack(Blocks.log, Bonsais.LOGSPERHARVEST, 2),
                    new ItemStack(Blocks.sapling, 1, 2) },
            new int[] { 80, 30 }, null, null),
    JUNGLE("Jungle", 1, new String[] { "Tree", "Bonsai", "Leavy" }, "Notch", new ItemStack(Blocks.sapling, 1, 3),
            new ItemStack[] { new ItemStack(Blocks.log, Bonsais.LOGSPERHARVEST, 3),
                    new ItemStack(Blocks.sapling, 1, 3) },
            new int[] { 80, 30 }, null, null),
    ACACIA("Acacia", 1, new String[] { "Tree", "Bonsai", "Leavy" }, "Notch", new ItemStack(Blocks.sapling, 1, 4),
            new ItemStack[] { new ItemStack(Blocks.log2, Bonsais.LOGSPERHARVEST), new ItemStack(Blocks.sapling, 1, 4) },
            new int[] { 80, 30 }, null, null),
    DARKOAK("Dark Oak", 1, new String[] { "Tree", "Bonsai", "Leavy", "Dark" }, "Notch",
    ...
    Bonsais(String name, int tier, String[] attributes, String discoveredBy, ItemStack seed, ItemStack[] gain,
            int[] chances, String[] pathToSprites, String modID, String... additionalDescriton) {
    ...
    static class InternalVanillaBonsais extends BasicCrop {
        ...
        public InternalVanillaBonsais(String name, int tier, String[] attributes, String discoveredBy, ItemStack[] gain,
                int[] chanches, String[] pathToSprites, String[] additionalDescriton) {
            this.name = name;
            this.tier = tier;
